...
<div class="slide">
    <div class="left">
        <div class="container">
            ...
            <div class="mySlides">
                ...
                <img src="assets/Images/1.png" style="width:75%">
            </div>

            <div class="mySlides">
                <div class="numbertext">2 / 6</div>
                <img src="assets/Images/2big.png" style="width:75%">
            </div>

            <div class="mySlides">
                <div class="numbertext">3 / 6</div>
                <img src="assets/Images/3big.png" style="width:75%">
            </div>
            ...
            <div class="row">
                <div class="column">
                    <img class="demo cursor" src="assets/Images/1sml.png" style="width:100%" onclick="currentSlide(1)">
                </div>
                <div class="column">
                    <img class="demo cursor" src="assets/Images/2.png" style="width:100%" onclick="currentSlide(2)">
                </div>
                <div class="column">
                    <img class="demo cursor" src="assets/Images/3.png" style="width:100%" onclick="currentSlide(3)">
                </div>
    ...
    <div class="right"><br>
        ...
        <br>
        <p>Check in: Wednesday, April 6, 2022<br>
...
<div class="details">
    ...
    <div class="textcolumn2">
        ...
        <button id="button-service" onclick="window.location.href='registration-form/index.html'">Book Now</button>
