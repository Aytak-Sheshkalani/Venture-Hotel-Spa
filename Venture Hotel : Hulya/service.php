...
?>
  ...
  <div class="header">
		<img src="../@B.P/Images/Services1.jpg" style="width: 100%;" alt="Service">
			 <div class="centered"><h1 style="font-size: 50px;"><b>Services</b></h1></div>
</div>
		</div>
<div class="row">
  <div class="column">
    <img src="../@B.P/Images/massage.jpg" alt="massage" style="width:100%">
  ...
  <div class="column">
    <img src="../@B.P/Images/restaurant.jpg" alt="Forest" style="width:100%">
	  <h2 style="padding-top: 10px;"><b>Restaurant</b></h2>
    <p>This hotel has many special massage<br>packages</p>
    <button id="button-service">MORE</button>
  </div>
  <div class="column">
    <img src="../@B.P/Images/valentine.jpg" alt="Mountains" style="width:100%">
...
<div class="row">
  <div class="column">
    <img src="../@B.P/Images/drinks.jpg" alt="massage" style="width:100%">
	<h2 style="padding-top: 10px;"><b>Alcoholic Drinks</b></h2>
    <p>This hotel has many special massage<br>packages</p>
    <button id="button-service">MORE</button>
  </div>
  <div class="column">
    <img src="../@B.P/Images/boards.jpg" alt="Forest" style="width:100%">
	  <h2 style="padding-top: 10px;"><b>charcuterie boards</b></h2>
    <p>This hotel has many special massage<br>packages</p>
    <button id="button-service">MORE</button>
  </div>
  <div class="column">
    <img src="../@B.P/Images/bike.jpg" alt="Mountains" style="width:100%">
